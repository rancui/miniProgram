...
}(require("../../npm/babel-runtime/regenerator/index.js")), 
...
s = require("../../npm/@hfe/mp-owl/lib/index.js"), 
n = require("../../actions/wx.js"),
o = require("../../npm/promise-polyfill/promise.js"), 
c = require("../base.js"), 
u = require("../../utils/image-scale.js"), 
l = require("../../utils/fix-coords.js"), 
h = require("../../store.js"),
d = require("../../utils/wait.js"), 
g = require("../../utils/promise-try.js"), 
_ = require("../../utils/mix.js"), 
p = require("./log.js"), 
f = require("../../api/wx.js").getLocation, 
v = function(e) {
...
w = require("../../api/index.js"),
m = w.searchHot, 
k = w.searchSuggestV8, 
b = w.searchPoi, 
x = w.getFilterConditions, 
S = require("../../api/wx.js"), 
L = S.storage, 
D = L.setItem, 
T = L.getItem, 
...
q = require("../../utils/find-index.js"), 
A = require("../../constants.js").KEY_HISTORY_LABELS, 
I = {
    labels: [],
    getAsync: function() {
        var e = this;
...
P = {
    ...
    onSearchInput: function(e) {
        console.log('=======onSearchInput========',this.searchManager.input);
