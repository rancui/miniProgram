...
<view class="page-container">
	<view class="search-container">
		<view class="index-search-bg">
		    ...
		    <input v-model="searchValue" type="text" placeholder="占位符"  placeholder-class="shop-search-placeholder" @confirm="onClickSearch" @input="onSearchInput" focus="true" class="index-search-input" ></input>
...
<style lang="scss">
	...
	.search-poi:last-child .search-poi-content:after,.search-poi:last-child .search-poi-query-content:after {
